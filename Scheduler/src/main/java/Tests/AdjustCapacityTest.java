...
public class AdjustCapacityTest {
   public static void main(String[] args) {
      ...
      driver.get("http://localhost:8080/Scheduler/adjustClass.jsp");
       	
      driver.findElement(By.name("room")).sendKeys("PKI 277"); 
      driver.findElement(By.name("seats")).sendKeys("30");
